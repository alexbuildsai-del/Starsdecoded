...
export const links: PairSectionSpec<typeof PairLinksSchema> = {
  ...
  instructions: `Write the link cards that sit under the bi-wheel in chapter one: one card per listed link, in the listed order, 45 to 60 words each; 70 is a hard ceiling and a card over it is rejected. The body fields take the key form (sun, moon, mercury, north_node), never the letter or the capitalised name.
