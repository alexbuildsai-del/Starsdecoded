...
Spawn the `orchestrator` agent on that plan. It branches, dispatches every
builder in a parallel group in one message and the groups in order, runs the gate, writes the round report, refreshes INDEX.md and the CLAUDE.md
