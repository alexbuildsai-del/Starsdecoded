# Index — regenerated at the end of every round (last: R06, 2026-09-21)
...
- `R06` the nine review fixes, the compatibility second pass (p2), on-tap scenes, MB-60 to 62; lab campaigns dispatched after the merge.

## QA — `docs/qa/` none yet. Annex: `docs/annex/staging-runbook.md`, the Owner's one-time staging setup.
