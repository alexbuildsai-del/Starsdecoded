...
- `docs/rounds/R03-plan.md` · `R03-report.md` — Observatory tokens, the wheel from real degrees, citations, house cards, hero and chapter shell. Owner acceptance pending.
