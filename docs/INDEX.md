# Index — regenerated at the end of every round (last: R08, 2026-09-25)
...
- `web/src/components/chart/` wheel geometry, `NatalWheel`, the bi-wheel · `web/src/components/report/` hero and its label solver, the pair hero,
  ...
  gather, birth time, lenses, product name, the workbook store, `failureCounts.ts` · `web/src/hooks/useLiveReport.ts` (`failureReason`)
