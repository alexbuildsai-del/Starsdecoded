# Index — regenerated at the end of every round (last: model-matrix revision lock, 2026-09-24)
...
- Notion Mailbox — https://app.notion.com/p/7522fd3c9fd9450094cfdebabd205d3d (2 blocking: MB-31 entity, MB-68 the OpenAI key has no credits; MB-60 to 62 done in R06; MB-63, 64, 65 built at their defaults; MB-66, 67 raised by R06; MB-6, 43, 47, 55 at their defaults; MB-57 credits DDL and no-credit CTA deferred to pricing; MB-58 old synastry rows hidden; MB-59 the claim lands without generating; MB-49/52 credit rules with pricing)
...
- `docs/specs/locked/report-lab-model-matrix.md` — next: GPT-6 Sol and Luna against gpt-5.2, OpenAI only; sessions generate
