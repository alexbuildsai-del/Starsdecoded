# Annex — the model matrix as locked 2026-09-21, the base of the revision

Revised 2026-09-24 by `docs/specs/locked/report-lab-model-matrix.md`, which wins wherever the two differ:
Groq, gpt-5-mini and the pre-dispatched matrix are gone; the lab runs at four levels.
