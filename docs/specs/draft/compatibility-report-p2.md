...
### Shape: eight chapters, the frame and the lens
- 01 How you meet (verdict headline, one scene, two because-lines, a new card: the three
  strengths as a pair, each cited) · 02 The two charts (bi-wheel, link cards, 100 to 140 word
  intro) · 03 to 07 set by the lens · 08 What to practise (the next-time items collected
  into the three checklists, nothing new, the 80 to 100 word closing). Two ways of being,
  Where it flows, Where it rubs and How you talk go; flow and friction live in every lens
  chapter's pattern block, and talking is a lens chapter in each lens.
...
### Lens 1, Partners (chapters 03 to 07)
03 How you love (care shown and wanted: words, time, help, gifts, touch, as vocabulary,
never a match; scenes: the end of a long day · a birthday, planned badly · the thumbs-up) ·
04 How you fight and repair (pursuer and withdrawer, the four corrosive habits and their
antidotes as plain behaviour, the repair each accepts; scenes: the argument at 11 pm · the
silent car ride · day two of an apology) · 05 Home, chores and money (whose standard, who
carries the list, how a bill lands, fairness as each feels it; scenes: the dishwasher, again
· the bill nobody expected · guests on Saturday) · 06 Fun, weekends and holidays (out against
...
07 What you are building (ambition, time apart, distance, the strengths as a pair; scenes:
...
- 03 What your child needs from you (scenes by band: bedtime, the third call · the morning
  rush · the closed door · the Sunday call) · 04 Feelings and the big reactions (emotion
  coaching's five moves, which one this parent skips; the supermarket floor · losing the game
  · the door slam after a text · the call that ends in silence) · 05 Home, chores and
  contributing (tidying before dinner · the room, the deal, the pocket money · the kitchen
  after they cooked · a week back home) · 06 School, homework and how they learn (autonomy
  support over control; the drawing that isn't "right" · homework at the kitchen table ·
  "I've revised" · the choice you don't understand) · 07 Rules, freedom and screens (warm and
...
- 03 In a room together (the big dinner · the meeting where one goes quiet · the party you
  both said yes to) · 04 Working on something together (planning mum's sixtieth · the project
  with the deadline · moving day) · 05 Having fun (the weekend away · the night that ended
  early, or late · the hobby one of you wanted to share) · 06 The hard talk (money between
  you · the feedback at work · the thing unsaid for a year) · 07 What you give each other
...
### Engine
- Fifteen lens chapter specs plus three fixed in `api/src/prompts/pair/`; `PairChapterSchema`
  becomes headline, card, scene, whatJustHappened (with becauseA, becauseB), pattern, nextTime,
...
- Rendering: `PairSections.tsx` gains the card, the scene block with its chip row, the
  because kickers and the next-time checklist; chapter 08 reuses `Checklist`.
...
## Acceptance criteria
1. `PAIR_CHAPTER_IDS` has eight ids; chapters 03 to 07 differ by lens in title, card, scene
   set and prose; 01, 02 and 08 are the same shape under every lens.
...
2. The third lens is Two people with a "how do you know each other" answer? Recommendation:
   yes. Default: yes.
3. The side-by-side card on every lens chapter? Recommendation: yes. Default: yes.

## Decisions to record
1. **Eight chapters, five by lens.** Three fixed around five day-to-day lens chapters, each
   a verdict, a side-by-side card, a scene, what just happened with two because-lines, the
   pattern, next time. 1,900 to 2,500 words of prose. Amends ADR-40's chapter list and band.
